...
namespace WaterSystem
{
    ...
    public class Water : MonoBehaviour
    {
        ...
        public static Water Instance
        {
            ...
            {
                if (_instance == null)
                    _instance = (Water)FindAnyObjectByType(typeof(Water));
                return _instance;
            }
        }
        // Script references
        ...
        public void CaptureDepthMap()
        {
            ...
            if (SystemInfo.graphicsDeviceType == GraphicsDeviceType.OpenGLES3 || SystemInfo.graphicsDeviceType == GraphicsDeviceType.OpenGLES3)
            {
