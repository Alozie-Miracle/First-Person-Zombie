...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        public class MovementSettings
        {
            ...
            public void UpdateDesiredTargetSpeed(Vector2 input, bool running)
            {
        ...
        private FirstPerson_InputSystem_Actions m_Actions;

        public FirstPerson_InputSystem_Actions Actions
        {
        ...
        private void Awake()
        {
            m_Actions = new FirstPerson_InputSystem_Actions();
            m_Actions.Player.Jump.performed += OnJumpPerformed;
        ...
        private Vector2 GetInput()
        {
            ...
            bool running = m_Actions.Player.Sprint.IsPressed();
            movementSettings.UpdateDesiredTargetSpeed(input, running);
            return input;
        }
        ...
        private void RotateView()
        {
            ...
            Vector2 lookInput = m_Actions.Player.Look.ReadValue<Vector2>();
